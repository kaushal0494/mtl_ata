...
def evaluate(args):
    ...
    # === Prepare output file ===
    output_file = os.path.join(args.output_dir, f"{os.path.basename(args.output_dir)}_results.json")
    with open(output_file, "w", encoding="utf-8") as f:
        ...
        for task, task_results in task_groups.items():
            ...
            task_macro_f1 = f1_score(labels, preds, labels=LABEL_LIST, average="macro", zero_division=0)
